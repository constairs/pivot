...
export const updateClass = updateData => axiosInstance.put(`/v1/trainer/class_sessions/${updateData.id}`, updateData.newData);
...
export const updateCollection = classesList => axiosInstance.put(
  `/v1/trainer/collections/${classesList.collectionId}`,
  {
    title: classesList.collectionId,
    class_sessions: classesList.class_sessions
  }
);
